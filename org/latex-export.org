...
#+LATEX_HEADER: \let\oldsqrt\sqrt
#+LATEX_HEADER: \renewcommand{\sqrt}[2][]{%
#+LATEX_HEADER: \ \oldsqrt[\raisebox{2pt}{$\scriptscriptstyle #1$}]{#2}%
#+LATEX_HEADER: }
...
#+LATEX_HEADER: \let\oldcprod\cprod
#+LATEX_HEADER: \renewcommand\cprod{\displaystyle\oldcprod}
...
#+LATEX_HEADER: {\left[\begin{array}{@{}l@{}}}
#+LATEX_HEADER: {\end{array}\right.}
